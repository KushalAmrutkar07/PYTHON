# Breast Cancer using RandomForest 
...
def data_file_to_csv():
    ...
    # Load the datset into Pandas data frame
    datase = read_data(INPUT_PATH)
...
# Output : Dataset after remocing missing values
# Author : Kushal Mahesh Amrutkar
# Date : 14/01/23  
#########################################
...
# Description : To train the random Forest classifeir with feature and target data
# Author : Kushal Mahesh Amrutkar
# Date : 14/01/23  
#########################################
...
def main():
    ...
    # Get basic statistics of the loaded datset
    ...
    print("Confusion matix", confusion_matrix(test_y,predictions)*100)
